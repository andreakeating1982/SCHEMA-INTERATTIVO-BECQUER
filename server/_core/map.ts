...
// Google Maps integration — requires GOOGLE_MAPS_PROXY_URL and GOOGLE_MAPS_API_KEY in .env
...
function getMapsConfig(): MapsConfig {
  ...
  if (!baseUrl || !apiKey) {
    throw new Error(
      "Google Maps credentials missing: set GOOGLE_MAPS_PROXY_URL and GOOGLE_MAPS_API_KEY in .env"
    );
  }
